...
function request($url, $customHeaders, $customData, $reqType, $returnResult) {
    ...
    $requestHeaders = [
                        ...
                        'Locale: en',
                        'Protocol-Version: 5',
                        'Referer: https://microsoft.gointeract.io/interact/index?interaction=1461173234028-3884f8602eccbe259104553afa8415434b4581-05d1&accountId=microsoft&appkey=196de13c-e946-4531-98f6-2719ec8405ce',
                        'Run-Mode: FULL',
...
if (isset($_GET['IID'])) {
    ...
    if (strlen($iid) == 54 || strlen($iid) == 63) {
        ...
        $headers = [];
        $data = null;
        $lnk = 'https://microsoft.gointeract.io/interact/version/2/account/microsoft/interaction/1461173234028-3884f8602eccbe259104553afa8415434b4581-05d1?interaction=1461173234028-3884f8602eccbe259104553afa8415434b4581-05d1&accountId=microsoft&appkey=196de13c-e946-4531-98f6-2719ec8405ce';
